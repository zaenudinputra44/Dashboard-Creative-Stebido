...
export const chartData = [
  { name: 'Senin', target: 0, realisasi: 0 },
  { name: 'Selasa', target: 0, realisasi: 0 },
  { name: 'Rabu', target: 0, realisasi: 0 },
  { name: 'Kamis', target: 0, realisasi: 0 },
  { name: 'Jumat', target: 0, realisasi: 0 },
  { name: 'Sabtu', target: 0, realisasi: 0 },
